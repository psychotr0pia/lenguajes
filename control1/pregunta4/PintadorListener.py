...
class PintadorListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PintadorParser#rotar.
    def enterRotar(self, ctx:PintadorParser.RotarContext):
        pass

    # Exit a parse tree produced by PintadorParser#rotar.
    def exitRotar(self, ctx:PintadorParser.RotarContext):
        pass
    ...
    # Enter a parse tree produced by PintadorParser#repetir.
    def enterRepetir(self, ctx:PintadorParser.RepetirContext):
        pass

    # Exit a parse tree produced by PintadorParser#repetir.
    def exitRepetir(self, ctx:PintadorParser.RepetirContext):
        pass


    # Enter a parse tree produced by PintadorParser#signos.
    def enterSignos(self, ctx:PintadorParser.SignosContext):
        pass

    # Exit a parse tree produced by PintadorParser#signos.
    def exitSignos(self, ctx:PintadorParser.SignosContext):
        pass
